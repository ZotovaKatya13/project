...
public class Registration {
    ...
    public void tearDown(){
        ...
        WebElement monthYear = driver.findElement (By.cssSelector(".react-datepicker__current-month"));
            while (!monthYear.getText().equals("June 1998")) {
               driver.findElement(By.cssSelector(".react-datepicker__navigation--previous")).click();
                monthYear = driver.findElement(By.cssSelector(".react-datepicker__current-month"));
            }
           ...
           WebElement day = driver.findElement(By.xpath("//div[text()='24']"));
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(Main.selectState));
            driver.findElement(Main.selectState).click();

            driver.findElement(Main.city).click();
            wait.until(ExpectedConditions.presenceOfElementLocated(Main.selectCity));
            driver.findElement(Main.selectCity).click();
